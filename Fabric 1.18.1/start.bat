...
:: SCRIPT ::
:start
:: Check if the latest version of Fabric exists
if exist server-launch_%version%_%loader%_%installer%.jar (
    ...
    :: If it doesn't, check if an outdated version of Fabric exists
    if exist server-launch*.jar (
        ...
        :: If it doesn't, download the latest version of Fabric and go back to the start
	    echo.
